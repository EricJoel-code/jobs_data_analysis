...
class JobsCategorization:
    ...
    # Función para categorizar el nivel del trabajo basado en el título del trabajo
    ...
    # Función para categorizar si el trabajo es remoto, híbrido o presencial basado en la descripción, ubicación y título del trabajo
    ...
    # Función para categorizar si el trabajo es remoto, híbrido o presencial basado en la columna 'remote' e 'is_remote'
