...
# Esta clase se encarga de extraer las habilidades mencionadas en las descripciones de los trabajos, así como el nivel de educación más alto mencionado y la experiencia requerida. Utiliza los diccionarios y listas definidas en el archivo de configuración para identificar y categorizar las habilidades, niveles de educación y experiencia.
class SkillsExtractor:
    ...
    def extract_skills(self, df):
        ...
        )if pd.isna(row['skills']) or row['skills'] == "" else row['skills'], axis=1)
